...
CREATE TABLE T09D_ENDERECO (
    ...
    NUMERO_CASA VARCHAR2(10) NOT NULL,
    NUMERO_CEP VARCHAR2(14) NOT NULL,
...
CREATE TABLE T09D_REGISTRO_DE_PONTO (
    ...
    ID_AJUSTE INTEGER, -- Agora permite NULL
    ID_COMPENSACAO INTEGER, -- Agora permite NULL
    ID_PONTO INTEGER NOT NULL,
    ID_PROFISSIONAL INTEGER NOT NULL,
    ID_ESCALA INTEGER NOT NULL,
    ID_FERIAS INTEGER, -- Agora permite NULL
