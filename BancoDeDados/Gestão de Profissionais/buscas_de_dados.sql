...
SELECT P.NOME, P.TELEFONE, P.EMAIL, S.NOME AS SETOR
...
SELECT R.DATA_REGISTRO, P.REGISTRO
...
SELECT B.DATA_BANCO, B.SALDO_HORA
...
WHERE O.ID_PROFISSIONAL = :ID_PROFISSIONAL;
...
-- 16.relação completa de um profissional
SELECT 
...
-- 18.pacientes e leitos com informações do profissional responsável
SELECT 
